library(deSolve)
library(shiny)
#library(ggplot2) ode-ibm_20160426/

#required data
age_prob_0to97 <- read.csv("data/0to97_age_prob.csv", header=FALSE)
male_prob_0to97 <- read.csv("data/0to97_male_prob.csv", header=FALSE)
age <- 0:97
